...
class CryptoPerformanceModel {
  ...
  factory CryptoPerformanceModel.fromRawJson(String str) =>
      CryptoPerformanceModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory CryptoPerformanceModel.fromJson(Map<String, dynamic> json) =>
      CryptoPerformanceModel(
