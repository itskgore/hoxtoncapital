...
class GetTopInstitute
    implements UseCase<ProviderResponseEntity, ProviderParams> {
  final GetProvidersRepository repository;

  GetTopInstitute(this.repository);

  @override
  Future<Either<Failure, ProviderResponseEntity>> call(
      ProviderParams params) async {
    return await repository.getTopInstitutes(params.param);
  }
}
