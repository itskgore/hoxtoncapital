...
class AddOtherLiabilitiesUsecase
    extends UseCase<OtherLiabilitiesEntity, AddUpdateOtherLiabilitiesParams> {
  AddOtherLiabilitiesUsecase(this.addUpdateOtherLiabilitiesRepo);
  ...
  Future<Either<Failure, OtherLiabilitiesEntity>> call(
    ...
    return addUpdateOtherLiabilitiesRepo.addOtherLiabilities(params);
  }
}
