...
class AddMortgagesUsecases extends UseCase<Mortgages, AddMortgagesParams> {
  AddMortgagesUsecases(this.addUpdateMortgagesRepo);

  final AddUpdateMortgagesRepo addUpdateMortgagesRepo;

  @override
  Future<Either<Failure, Mortgages>> call(AddMortgagesParams params) {
    return addUpdateMortgagesRepo.addMortgages(params);
  }
}
