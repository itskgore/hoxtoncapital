...
import 'add_liabilities_page/presentation/pages/add_liabilities_page.dart';
// import 'package:wedge/dependency_injection.dart';

class LiabilitiesSuccessPage extends StatelessWidget {
        ...
        body: ListView(
          children: [
            Padding(
              ...
              child: Text(
                addAssetsSuccessMessage(PERSONAL_LOANS),
                style: const TextStyle(
                    fontSize: kfontMedium, color: kfontColorDark),
