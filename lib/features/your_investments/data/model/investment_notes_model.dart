...
class InvestmentNotesModel {
  InvestmentNotesModel({
    this.id,
    this.source,
    this.name,
    this.investmentType,
  ...
  factory InvestmentNotesModel.fromRawJson(String str) =>
      InvestmentNotesModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory InvestmentNotesModel.fromJson(Map<String, dynamic> json) =>
      InvestmentNotesModel(
        id: json["id"],
        source: json["source"],
        name: json["name"],
