...
class DropdownDatePicker extends StatefulWidget {
  ...
  final double? yearMenuMaxHeight;
  final double? monthMenuMaxHeight;
  final double? dayMenuMaxHeight;
  ...
  DropdownDatePicker(
      ...
      this.dayFlex = 1,
      this.yearFlex = 2,
      this.monthMenuMaxHeight,
      this.yearMenuMaxHeight,
      this.dayMenuMaxHeight})
...
class _DropdownDatePickerState extends State<DropdownDatePicker> {
  ...
  DropdownButtonFormField<String> monthDropdown() {
    return DropdownButtonFormField<String>(
        ...
        menuMaxHeight: widget.monthMenuMaxHeight,
  ...
  DropdownButtonFormField<String> yearDropdown() {
    return DropdownButtonFormField<String>(
        ...
        menuMaxHeight: widget.yearMenuMaxHeight,
        borderRadius: BorderRadius.circular(8),
        elevation: 2,
        onChanged: (value) {
          yearsSelected(value);
  ...
  DropdownButtonFormField<String> dayDropdown() {
    return DropdownButtonFormField<String>(
        ...
        menuMaxHeight: widget.dayMenuMaxHeight,
        borderRadius: BorderRadius.circular(8),
        elevation: 2,
        onChanged: (value) {
          daysSelected(value);
